...
import MarkdownElement from 'training/src/components/MarkdownElement';
import Demo from 'training/src/components/Demo';
...
function MarkdownDocs(props) {
  ...
  if (route.componentAPI) {
    ...
    markdownUrl += `/training/src/pages/component-demos${route.demo.path.replace('./', '/')}`;
  } else {
    markdownUrl += `/training/src/pages${route.path}.md`;
  }
